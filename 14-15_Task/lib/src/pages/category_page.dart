...
class _CategoryPageState extends State<CategoryPage> {
  ...
  Future<void> deleteFood(Food food) async {
    try {
      ...
      favoritesProvider.removeFavorite(context, food.id!);
      final shoppingCart = Provider.of<ShoppingCart>(context, listen: false);
      shoppingCart.removeItem(context, food);
    } catch (e) {
                    ...
                    (context, index) {
                      return GestureDetector(
                        child: FoodItem(
                          ...
                          onUpdate: () => setState(() {}),
                          onAdd: () {
                            shoppingCart.addItem(context, _filteredFoods[index]);
                          },
                          onRemove: () {
                            shoppingCart.removeItem(context, _filteredFoods[index]);
                          },
                          onIncrement: () {
                            shoppingCart.incrementItem(context, _filteredFoods[index]);
                          },
                          onDecrement: () {
                            shoppingCart.decrementItem(context, _filteredFoods[index]);
                          },
                        ),
                      );
                    },
