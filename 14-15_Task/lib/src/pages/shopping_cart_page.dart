...
class ShoppingCartPage extends StatelessWidget {
  ...
  Future<bool> _loadCartData(BuildContext context) async {
    ...
    await shoppingCart.initializeCart(context);
    return true;
  }
  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    try {
      ...
      await _orderService.placeOrder(userId!); // Оформляем заказ на сервере
            ...
            itemBuilder: (context, index) {
              ...
              return Slidable(
                    ...
                    SlidableAction(
                      onPressed: (context) async {
                        ...
                        if (shouldDelete == true) {
                          ...
                          shoppingCart.initializeCart(context);
                        }
                      },
                ...
                child: ShoppingCartFoodItem(
                  ...
                  onIncrement: () {
                    shoppingCart.incrementItem(context, food);
                  },
                  onDecrement: () {
                    shoppingCart.decrementItem(context, food);
                  },
                ),
              );
            },
