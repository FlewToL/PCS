...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void createNewUser(userId) async {
    try {
      await foodService.createUser(userId, 'Roman', 'user');
      print('Пользователь успешно создан.');
    } catch (e) {
      print('Не удалось создать пользователя: $e');
    }
  }
...
// prepare data
    ...
    try {
      ...
      favoritesProvider.updateFavoritesData();
      shoppingCart.updateCartData();
