...
class _FavoriteFoodItemState extends State<FavoriteFoodItem> {
  ...
  Widget build(BuildContext context) {
    ...
    void toggleFavorite() {
      if (isFavorite) {
        favoritesProvider.removeFavorite(context, widget.item.id!);
      } else {
        favoritesProvider.addFavorite(context, widget.item);
      }
      setState(() {});
    }
                    ...
                    child: isInCart
                      ...
                      children: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              shoppingCart.decrementItem(context, widget.item);
                            });
                          },
                          icon: const Icon(
                            Icons.remove,
                        ...
                        IconButton(
                          onPressed: () {
                            setState(() {
                              shoppingCart.incrementItem(context, widget.item);
                            });
                          },
                          icon: const Icon(
                            Icons.add,
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          setState(() {
                            shoppingCart.addItem(context, widget.item);
                            shoppingCart.incrementItem(context, widget.item);
                          });
                        },
                        iconSize: 24,
