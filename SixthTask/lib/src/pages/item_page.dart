...
class _ItemPageState extends State<ItemPage> {
  ...
  Widget build(BuildContext context) {
    ...
    void toggleFavorite() {
      if (isFavorite) {
        favoritesProvider.remove(widget.food);
      } else {
        favoritesProvider.add(widget.food);
      }
      setState(() {});
    }
                ...
                child: Container(
                  ...
                  child: isInCart
                      ? Row(
                          ...
                          children: [
                            IconButton(
                              onPressed: () {
                                setState(() {
                                  shoppingCart.decrementItem(widget.food);
                                  widget.onUpdate();
                                });
                              },
                              icon: const Icon(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${(widget.food.inCart * widget.food.salePrice*100).round()/100} ₽',
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontSize: 16,
                                  ),
                            ...
                            IconButton(
                              onPressed: () {
                                setState(() {
                                  shoppingCart.incrementItem(widget.food);
                                  widget.onUpdate();
                                });
                              },
                              icon: const Icon(
                      ...
                      : InkWell(
                          onTap: () {
                            setState(() {
                              shoppingCart.addItem(widget.food);
                              shoppingCart.incrementItem(widget.food);
                              widget.onUpdate();
                            });
                          },
